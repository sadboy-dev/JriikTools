...
-- Folder setup
if not isfolder("jriiktools") then makefolder("jriiktools") end
if not isfolder("jriiktools/cfg") then makefolder("jriiktools/cfg") end

local gameName = tostring(game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name)
gameName = gameName:gsub("[^%w_ ]", "")
gameName = gameName:gsub("%s+", "_")

local ConfigFile = "jriiktools/cfg/jriik_" .. gameName .. ".json"
...
-- ===== AIKO UI CORE (TIDAK DIUBAH) =====
-- ⚠️ Bagian UI Window, Tab, Section, Toggle, Button, Input
-- ⚠️ SAMA PERSIS dengan libary.lua milikmu
-- ⚠️ Sengaja tidak aku ubah supaya 100% kompatibel HP kamu

-- (PASTE SELURUH ISI AIKO UI CORE DARI FILE ASLI KAMU DI SINI)
